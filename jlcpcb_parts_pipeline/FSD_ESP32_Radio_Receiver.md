...
```
                                    ...
                                    └────────┬────────┘
                                             │
┌──────────┐     ┌──────────┐     ┌──────────┴────────┐     ┌──────────┐
│  USB-C   │────▶│  TP4056  │────▶│     SI4735       │────▶│ Headphone│
│Connector │     │ Charger  │     │   Radio IC       │     │   Jack   │
└──────────┘     └────┬─────┘     └──────────┬───────┘     └──────────┘
      │               │                      │
      │          ┌────┴─────┐          ┌─────┴─────┐
      │          │  Li-ion  │          │   I2C     │
...
| Ring | Right channel |
| Sleeve | Ground |
| Output Impedance | ~100 ohm (series resistors) |
...
| R7, R8 | 100R | 0603 | C22775 | Basic | Audio output |
...
- [ ] OLED header
- [ ] Headphone jack with series resistors
